...
_SCHEMA_OVERRIDES: Dict[str, Dict[str, Any]] = {
    ...
    "dashboard.theme": {
        ...
        "options": ["default", "dark", "dark-large", "midnight", "ember", "mono", "cyberpunk", "rose", "codex"],
    },
...
_BUILTIN_DASHBOARD_THEMES = [
    ...
    {"name": "dark",          "label": "Dark",                "description": "Dark flat rebuilt — no background artwork"},
    {"name": "dark-large",    "label": "Dark (Large)",        "description": "Dark flat rebuilt, larger type and wider spacing"},
    ...
    {"name": "codex",     "label": "Codex",          "description": "VS Code-like flat dark — JetBrains Mono, green accents"},
]
