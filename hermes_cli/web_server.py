...
_BUILTIN_DASHBOARD_THEMES = [
    ...
    {"name": "dark",          "label": "Dark",                "description": "Stable official dark theme"},
    {"name": "dark-large",    "label": "Dark (Large)",        "description": "Stable official dark theme, larger type and wider spacing"},
